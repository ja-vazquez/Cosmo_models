...
set title "O_{m}=O_{m,fid}   ,   h=h_{fid}"
set key left bottom
...
plot [0.01:][]'G_fix_LCDM.out' w l title 'LCDM' ls 1, 'G_fix_LCDM.out' u 1:((0.27*$1**(-1)*(0.000233/$3)**2)**0.55) w l title '{/Symbol W}_{m}(a)^{0.55}' ls 2, 'G_fix_01.out' w l title '{/Symbol W}_{ede} = 0.1' ls 3, 'G_fix_02.out' w l title '{/Symbol W}_{ede} = 0.2' ls 4
